...
packages <- c("dplyr", "tidyr", "tibble", "knitr", "plotROC", "corrplot",
              "rpart", "rpart.plot", "randomForest", "caret", "ggplot2",
              "fastDummies", "plotly", "FactoMineR", "factoextra", "kernlab", "gridExtra")
mypack(packages)
```
...
str(test_df_categorical)
test_df_categorical$Accident_Severity = as.factor(test_df_categorical$Accident_Severity)
